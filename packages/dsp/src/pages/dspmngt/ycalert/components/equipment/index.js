...
export default function AlarmEvent(props) {
  ...
  let searchVal = { queryVal: queryVal, startTime: olddate, endTime: newdate, devtype: 'device'}
  ...
  return (
    <>
      <ProtableModule
        ...
        incID={incID}
        rowkey={rowKey}
        tableKey="dspycalequi"
        columns={columnsList}
        apishowurl="/cfg.php?controller=logDispose&action=showAttack"
        setcolumnKey="pro-table-singe-demos-dspycalequi"
        columnvalue="dspycalequiColumnvalue"
        rowSelection={true}
        delButton={false}
        showLoading={false}
