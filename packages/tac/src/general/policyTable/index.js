...
const Policy = forwardRef(({ ...props }, ref) => {
  ...
  const tableTopSearch = () => {
    return (
      <Search placeholder={ isOptionHide ? language('mconfig.attachck.tacsechholder') : language('mconfig.attachck.searchholder')}
        onSearch={(queryVal) => {
  ...
  return (<>
    <ModalForm formRef={editformRef} submitTimeout={2000}
      ...
      title={modalVal == 'distribute' ? language('mconfig.attachck.distributeTitle') : modalVal == 'assoc' ? language('mconfig.attachck.assocTitle') : language('mconfig.attachck.revokeTitle')}
