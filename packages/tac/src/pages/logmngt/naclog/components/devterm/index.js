...
export default () => {
  const columns = [
    {
      disable: true,
      width: 90,
      title: language('logmngt.devterm.id'),
      dataIndex: 'id',
      ellipsis: true,
      hideInTable:true,
      align: 'left',
    },
    {
      disable: true,
      width: 160,
      title: language('logmngt.devterm.time'),
      dataIndex: 'time',
      ellipsis: true,
      align: 'left',
    },
    {
      disable: true,
      title: language('logmngt.devterm.event'),
      dataIndex: 'event',
      align: 'left',
      ellipsis: true,
      width: 100,
    ...
    {
      disable: true,
      title: language('logmngt.devterm.devip'),
      dataIndex: 'devip',
      align: 'left',
      ellipsis: true,
      width: 130,
    ...
    {
      disable: true,
      title: language('logmngt.devterm.details'),
      dataIndex: 'details',
      ellipsis: true,
      align: 'left',
    },
  ...
  const tableKey = 'devterm'
  const setcolumnKey = 'pro-table-singe-demos-devterm';
  ...
  const apishowurl = '/cfg.php?controller=log&action=showTermDev';
  const columnvalue = 'devtermcolumnvalue';
  ...
  const tableTopSearch = () => {
    return (
      <Space>
        <Search
          placeholder={language('logmngt.devterm.tablesearch')}
          style={{ width: 200 }}
          onSearch={(queryVal) => {
