...
export default () => {
  const columns = [
    {
      disable: true,
      width: 90,
      title: language('logmngt.visitor.id'),
      dataIndex: 'id',
      ellipsis: true,
      hideInTable:true,
      align: 'left',
    },
    {
      disable: true,
      width: 160,
      title: language('logmngt.visitor.time'),
      dataIndex: 'time',
      ellipsis: true,
      align: 'left',
    },
    {
      disable: true,
      title: language('logmngt.visitor.event'),
      dataIndex: 'event',
      align: 'left',
      ellipsis: true,
      width: 100,
    ...
    {
      disable: true,
      title: language('logmngt.visitor.devip'),
      dataIndex: 'devip',
      align: 'left',
      ellipsis: true,
      width: 130,
    },
    {
      disable: true,
      width: 100,
      title: language('logmngt.visitor.visitorname'),
      dataIndex: 'visitor',
      ellipsis: true,
      align: 'left',
    },
    {
      disable: true,
      width: 120,
      title: language('logmngt.visitor.logindev'),
      dataIndex: 'regDev',
      ellipsis: true,
      align: 'left',
    },
    {
      disable: true,
      title: language('logmngt.visitor.details'),
      dataIndex: 'details',
      ellipsis: true,
      align: 'left',
    },
  ...
  const tableKey = 'logvisitor'
  const setcolumnKey = 'pro-table-singe-demos-logvisitor';
  ...
  const apishowurl = '/cfg.php?controller=log&action=showTermVisitor';
  const columnvalue = 'logvisitorcolumnvalue';
  ...
  const tableTopSearch = () => {
    return (
      <Space>
        <Search
          placeholder={language('logmngt.visitor.tablesearch')}
          style={{ width: 200 }}
          onSearch={(queryVal) => {
