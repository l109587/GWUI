...
export default () => {
  const columns = [
    ...
    },
    {
      disable: true,
      width: 160,
      title: language('logmngt.net.time'),
      dataIndex: 'time',
      ellipsis: true,
      align: 'left',
    },
    {
      disable: true,
      title: language('logmngt.net.event'),
      dataIndex: 'event',
      align: 'left',
      ellipsis: true,
      width: 100,
    ...
    {
      disable: true,
      title: language('logmngt.net.devip'),
      dataIndex: 'devip',
      align: 'left',
      ellipsis: true,
      width: 130,
    },
    {
      disable: true,
      width: 100,
      title: language('logmngt.net.ipaddr'),
      dataIndex: 'ipaddr',
      ellipsis: true,
      align: 'left',
    },
    {
      disable: true,
      title: language('logmngt.net.details'),
      dataIndex: 'details',
      ellipsis: true,
      align: 'left',
    },
  ...
  const tableKey = 'lognet'
  const setcolumnKey = 'pro-table-singe-demos-lognet';
  ...
  const apishowurl = '/cfg.php?controller=log&action=showTermNet';
  const columnvalue = 'lognetcolumnvalue';
  ...
  const tableTopSearch = () => {
    return (
      <Space>
        <Search
          placeholder={language('logmngt.net.tablesearch')}
          style={{ width: 200 }}
          onSearch={(queryVal) => {
