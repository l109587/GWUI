...
import { ReloadOutlined, SearchOutlined, CheckOutlined, CloseCircleOutlined, EyeFilled } from '@ant-design/icons';
import { ProTable, DrawerForm, ProFormSelect, ProFormTextArea, ProCard, ProDescriptions, ProFormText, ProFormCheckbox, ProFormSwitch } from '@ant-design/pro-components';
...
import { NotesText } from '@/utils/fromTypeLabel';
		...
		<DrawerForm
			...
			<div ref={pdfFormRef}>
				<div style={{ padding: '24px' }}>
					{isBatch == 'Y' ?
						<BatchTemplate dataSource={topData} contractSig={contractSign ? true : false} bottomData={bottomData} editable={false} title={signTitle} signName={signName} dateTime={signDataTime} batchData={batchData} />
						: <SignTable dataSource={topData} contractSig={contractSign ? true : false} bottomData={bottomData} editable={false} title={signTitle} signName={signName} dateTime={signDataTime} />
					}
				</div>
			</div>
		</DrawerForm>
		...
		<DrawerForm
			...
			<div className='approvalprocess alfrommodalmargin'>
				...
				<NotesText
					...
					label={language('project.resmngt.resapply.approvedescription')}
					width='280px'
				/>
