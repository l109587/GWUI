...
import { ExclamationCircleOutlined, UnorderedListOutlined, FileOutlined, LoadingOutlined } from '@ant-design/icons';
...
export default () => {
    ...
    const downloadClick = (list = {}) => {
        let api = '/cfg.php?controller=confIPAddrManage&action=exportIPNetAddr';
        let data = list;
