...
import { CheckOutlined, CloseCircleOutlined, IdcardFilled, UnorderedListOutlined, ClusterOutlined, EditFilled, SaveFilled, EyeFilled } from '@ant-design/icons';
...
export default (props) => {
    ...
    const getMenu = (type = false) => {
        ...
        data.vlan = initialValue.vlan;//管理员所属区域id    
    ...
    return (<>
        ...
        <ModalForm {...modalFormLayout}
            ...
            <ProFormSelect options={subNetList}
                name="subnet"
                label={language('project.resmngt.addrallc.subnet')}
            />
            <ProFormRadio.Group
                name="validType"
