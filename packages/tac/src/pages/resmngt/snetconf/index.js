...
import { Button, Input, message, Modal, TreeSelect, Row, Col, Tag, Slider, InputNumber, Space, Checkbox, Menu, Spin } from 'antd';
import { fileDown, post } from '@/services/https';
import { ClusterOutlined, ExclamationCircleOutlined, UnorderedListOutlined, LoadingOutlined } from '@ant-design/icons';
...
export default () => {
    ...
    const downloadClick = (list = {}) => {
        let api = '/cfg.php?controller=confIPAddrManage&action=exportIPSubNetAddr';
        let data = list;
