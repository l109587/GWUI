...
import { Modal, Input, message, Form, Switch, Popconfirm } from 'antd';
import { EditFilled, DeleteFilled, SaveFilled, ExclamationCircleOutlined, CloseCircleFilled } from '@ant-design/icons';
...
export default () => {
	...
	const apiBlklistShowUrl = '/cfg.php?controller=device&action=showCfgLinkDev'
	...
	return (
		<div>
			...
			>
				...
				<TableList apishowurl={apiBlklistShowUrl} key='aptaddr' className='blklisttable' id={rowRecord.id} concealColumns={concealColumn} columns={BlklistColumns} />
