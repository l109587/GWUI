...
export default () => {
    ...
    const syncundosaveurl = '/cfg.php?controller=confWhitelist&action=syncLanWhiteList';//同步撤销接口
    const assocshowurl = '/cfg.php?controller=device&action=showCfgLinkDev';//设备列表接口路径
    const cfg_type_type = 'cfgLanWhiteIP';//设备列表类型
    const tableKeyVal = 'whitedevw';//列表唯一key
