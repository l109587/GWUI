...
import { NameText, ContentText, NotesText } from '@/utils/fromTypeLabel';
...
export default (props) => {
  ...
  const authTypeOptions = [
    ...
    { label: language('mconfig.agtpolicy.domainloginauthentication'), value: 'domain', title: language('mconfig.agtpolicy.field') },
    { label: language('mconfig.agtpolicy.systemaccountauthentication'), value: 'sysuser', title: language('mconfig.agtpolicy.system') },
    { label: language('mconfig.agtpolicy.accountpasswordauthentication'), value: 'userpass', title: language('mconfig.agtpolicy.account') },
  ...
  return (
    <div>
      ...
      <ModalForm
        ...
        />
        <NotesText label={language('mconfig.agtpolicy.notes')} name='notes' required={false} type={'text'} rules={
          [{
            required: false,
                ...
                <Col offset={4}>
                  <Space>
                    <div className='flexbox'>
                      ...
                      <ProFormDigit placeholder={''} initialValue={5} width='70px' name='idleTime' min={5} max={180} />
                ...
                <Col offset={4}>
                  <Space>
                    <div className='flexbox'>
                      ...
                      <ProFormDigit initialValue={1} placeholder={''} width='70px' name='expireTime' min={1} max={30} />
                  ...
                  <Space>
                    <div className='flexbox'>
                      ...
                      <ProFormCheckbox name='checkInnerDot1x'
                        fieldProps={{
                          onChange: (e) => {
                            ...
                            setCheckInnerStatus(e.target.checked)
                          }
                        }}
                      />
                      ...
                      <ProFormSelect style={{ marginLeft: '5px', width: '222px' }}
                        ...
                        name='dot1xCheckMode'
                        rules={checkInnerStatus ? [{ required: true }] : false}
                        options={[
