...
export default (props) => {
  ...
  const [regTypeStatus, setRegTypeStatus] = useState(1);
      ...
      <ModalForm
        ...
        <div className='registerbox'>
          <ProFormRadio.Group
            ...
            options={regTypeList}
            onChange={(e)=>{
              setRegTypeStatus(e.target.value)
            }}
          />
        </div>
        {regTypeStatus == '2' ? 
