...
import { ElectronicSeal } from '@/common';
...
export default function SignTable(props) {
  ...
  let sqID = isSqOrder ? '122' : '1212323';
      ...
      return (
        ...
        >
          ...
          <td
            ...
            style={item.id == sqID && contractSig ? {
              textAlign: 'left',
              paddingLeft: '5%',
              paddingRight: '30%',
              position: 'relative',
          ...
          >
            <div>
              ...
              {item.id == sqID && contractSig ?
                <div style={{ position: 'absolute', right: '10px', marginTop: isSqOrder ? '-50px' : '-49px' }}><ElectronicSeal /></div>
                : <></>
              }
              <div>{item.date}</div>
            </div>
