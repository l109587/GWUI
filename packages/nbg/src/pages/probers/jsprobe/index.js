...
const Configuration = () => {
  ...
  const columns = [
    ...
    {
      title: language('probers.jsprobe.config.checkCnt'),
      dataIndex: 'checkCnt',
      width: '10%',
      ellipsis: true,
      readonly: true,
    ...
    {
      title: language('probers.jsprobe.config.chcheckSuccCnteckCnt'),
      dataIndex: 'checkSuccCnt',
      width: '10%',
      ellipsis: true,
      readonly: true,
    },
  ...
  return (
    <div className='jsprobeContent'>
      ...
      <ProCard ghost direction='column' gutter={[13, 13]}>
        <ProCard 
          className='jsprobeFormCard' 
          title={language('project.temporary.srcprobes.scrprotitle')}
          style={{ height: '345px' }}
        > 
          <div className='formDiv'>
            <ProForm 
              ...
              <div className='scrollDiv' style={{ maxHeight: "230px", overflowY: "auto" }}>
                  <ProFormSelect 
                ...
                <Col className='periodDiv' offset={6} style={{ marginTop: '-8px' }}>
                  <ProFormDigit 
                    name="period"
          ...
          <div className='tipDiv'>
            <Alert 
              className='probealert' 
              message={language('probers.jsprobe.alertmes')} 
              description={language('probers.jsprobe.description')} 
              type="info" 
              showIcon 
            />
          </div>
