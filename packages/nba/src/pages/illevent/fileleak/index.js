...
import { Space, Select, Tag, Input, DatePicker, Spin } from 'antd';
...
export default () => {
  ...
  const tableTopSearch = () => {
    ...
    const downloadClick = () => {
      ...
      download(
        '/cfg.php?controller=fileLeakEvent&action=export',
        data,
        setDownLoading
      )
    }

  return (<Spin spinning={downLoading} tip={language('project.exporting')}>
