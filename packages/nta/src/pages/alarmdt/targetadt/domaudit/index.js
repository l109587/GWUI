...
export default function Trojan() {
  ...
  const columnlist = [
    ...
    {
      title: language('alarmdt.targetadt.dnsdomain'),
      dataIndex: 'domain',
      key: 'domain',
      width: '120px',
      ellipsis: true,
  ...
  return (
    <>
      <ProtableModule
        columns={columns}
        apishowurl="/cfg.php?controller=logAlarm&action=showTargetDomain"
        clientHeight={clientHeight}
        columnvalue="aatdomauditColumnvalue"
        tableKey="aatdomauditTable"
        rowkey='id'
        incID={incID}
