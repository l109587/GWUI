...
export default function Trojan() {
  ...
  const columnlist = [
    ...
    {
      title: language('alarmdt.attacker.abnormalbasis'),
  ...
  return (
    <>
      <ProtableModule
        columns={columns}
        apishowurl="/cfg.php?controller=logAlarm&action=showAbnormalBehavior"
        clientHeight={clientHeight}
        columnvalue="atabnormalColumnvalue"
        tableKey="atabnormalTable"
        rowkey='id'
        incID={incID}
