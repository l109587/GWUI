...
const Email = () => {
  ...
  const columns = [
    ...
    {
      title: language('netaudit.appbevr.email.sendername'),
    ...
    {
      title: language('netaudit.appbevr.email.returnpath'),
      dataIndex: 'returnpath',
      key: 'returnpath',
      width: '100px',
      ellipsis: true,
      align: 'left',
    ...
    {
      title: language('netaudit.appbevr.email.xoriginationip'),
      dataIndex: 'x_origination_ip',
      key: 'x_origination_ip',
      width: '160px',
      ellipsis: true,
      align: 'left',
    },
    {
      title: language('netaudit.appbevr.email.xoriginationipurl'),
      dataIndex: 'url',
      key: 'url',
      width: '160px',
      ellipsis: true,
    ...
    {
      title: language('netaudit.appbevr.email.received'),
      dataIndex: 'received',
      key: 'received',
      width: '140px',
      ellipsis: true,
