...
import sysDeploy from './nta/sysDeploy'
...
export default {
	'post /cfg.php': (req, res) => {
		...
		if(getParam.controller == 'mtaConf'){
			...
			sysMonitor(getParam, postParam, res)
		}
		else if(getParam.controller == 'sysAnalysis'){
			sysAnalysis(getParam, postParam, res)
		}
		else if(getParam.controller == 'confMirror'){
			confMirror(getParam, postParam, res)
		}
		else if(getParam.controller == 'confReport'){
			confReport(getParam, postParam, res)
		}
		else if(getParam.controller == 'ntaAlarmLog'){
			alarmditFn(getParam, postParam, res)
		}
