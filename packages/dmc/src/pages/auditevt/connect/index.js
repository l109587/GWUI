...
const Connect = () => {
  ...
  const columns = [
    ...
    {
      title: language('netaudit.connect.appname'),
      dataIndex: 'app_name',
      key: 'app_name',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('netaudit.connect.sessid'),
      dataIndex: 'sess_id',
      key: 'sess_id',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('netaudit.connect.uppayload'),
      dataIndex: 'up_payload',
      key: 'up_payload',
      width: '100px',
      ellipsis: true,
      align: 'left',
    ...
    {
      title: language('netaudit.connect.downpayload'),
      dataIndex: 'down_payload',
      key: 'down_payload',
      width: '100px',
      ellipsis: true,
      align: 'left',
