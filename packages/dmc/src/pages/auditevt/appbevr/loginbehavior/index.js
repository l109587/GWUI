...
const Email = () => {
  ...
  const columns = [
    ...
    {
      title: language('netaudit.appbevr.loginbehavior.user'),
      dataIndex: 'user',
      key: 'user',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('netaudit.appbevr.loginbehavior.passwd'),
      dataIndex: 'passwd',
      key: 'passwd',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('netaudit.appbevr.loginbehavior.info'),
      dataIndex: 'info',
      key: 'info',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('netaudit.appbevr.loginbehavior.ret'),
      dataIndex: 'ret',
      key: 'ret',
      width: '100px',
      ellipsis: true,
  ...
  const apishowurl = "/cfg.php?controller=logAudit&action=showLoginAction"
  ...
  return (<>
    <ProtableModule
      tableKey={'loginbehaviorTable'} 
      columnvalue={'loginbehaviorColumnvalue'} 
      rowkey={'id'} 
