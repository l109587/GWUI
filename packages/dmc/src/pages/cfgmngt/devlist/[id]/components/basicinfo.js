      ...
      <div className='dmcbasicinfo'>
        ...
        <ProCard ghost direction='column' >
          ...
          <div className='deeditlabel'> 
					<ProDescriptions column={2}>
						<ProDescriptions.Item label={language('cfgmngt.devlist.cpuinfo')}>
          ...
          <ProDescriptions column={2}>
            ...
            <ProDescriptions.Item label={language('cfgmngt.devlist.publicipaddress')}>{detailInfo.public_ip_address ? detailInfo.public_ip_address : ''} </ProDescriptions.Item>
        	</ProDescriptions>
          <div className='deeditlabel'>
