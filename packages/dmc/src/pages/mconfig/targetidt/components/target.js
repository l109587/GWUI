...
import { ModalForm, ProFormText, ProFormSwitch, EditableProTable } from '@ant-design/pro-components';
...
const Ipaudit = () => {
  ...
  return (<>
    ...
    <ModalForm formRef={formRef} {...modalFormLayout} submitTimeout={2000}
      autoFocusFirstInput title={language('dmcoconfig.targetidt.targetrecognition')}
