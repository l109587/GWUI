...
const Keyword = () => {
  ...
  const columnvalue = 'tsensitivewhiteColunmval';
  const tableKey = 'tsensitivewhite';
  const module = 'sensitive_whitelist';
  ...
  return (
    <>
      ...
      <ModalForm formRef={formRef} {...modalFormLayout} submitTimeout={2000}
        autoFocusFirstInput title={language('dmcoconfig.transmchk.filehashwhitelistrule')}
