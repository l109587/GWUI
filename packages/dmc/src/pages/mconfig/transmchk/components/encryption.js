...
const Encryption = () => {
  ...
  const columnvalue = 'encryptionColunmval';
  ...
  return (<>
    ...
    <ModalForm formRef={formRef} {...modalFormLayout} submitTimeout={2000}
      autoFocusFirstInput title={language('dmcoconfig.transmchk.encryption.modaltitle')}
      ...
      <div className='flexDiv'>
        <ProFormText width={210} name='minsize' label={language('dmcoconfig.transmchk.minsize')} addonAfter={afterDiv('KB')} rules={[{
          required: true,
          message: language('project.mandatory')
        }]} />
        <ProFormText width={210} name='maxsize' label={language('dmcoconfig.transmchk.maxsize')} addonAfter={afterDiv('KB')} rules={[{
          required: true,
          message: language('project.mandatory')
        }]} />
      </div>
