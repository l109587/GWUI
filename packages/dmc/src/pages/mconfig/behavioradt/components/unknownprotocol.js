...
const Behareport = () => {
  ...
  const module = 'unknown_protocol';

  const apishowurl = '/cfg.php?controller=confPolicy&action=show';
  const columnvalue = 'unknownprotocolColumnvalue';
  const tableKey = 'unknownprotocol';
  ...
  return (<>
    ...
    <ModalForm formRef={formRef} {...modalFormLayout} submitTimeout={2000}
      autoFocusFirstInput title={language('dmcoconfig.behavioradt.unknownprotocolauditrule')}
