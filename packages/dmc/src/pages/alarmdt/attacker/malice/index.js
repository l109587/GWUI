...
export default function Trojan(props) {
  ...
  const columnlist = [
    ...
    {
      title: language('alarmdt.attacker.filesname'),
      dataIndex: 'filename',
      key: 'filename',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.attacker.filesize'),
      dataIndex: 'filesize',
      key: 'filesize',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.attacker.maliciousfamily'),
      dataIndex: 'malicious_family',
      key: 'malicious_family',
      width: '130px',
      ellipsis: true,
      align: 'left',
    },
    {
      title: language('alarmdt.attacker.filedir'),
      dataIndex: 'file_dir',
      key: 'file_dir',
      width: '120px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.attacker.filemd5'),
      dataIndex: 'file_md5',
      key: 'file_md5',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.attacker.fileurl'),
      dataIndex: 'file_url',
      key: 'file_url',
      width: '100px',
      ellipsis: true,
  ...
  return (
    <>
      <ProtableModule
        columns={columns}
        apishowurl="/cfg.php?controller=logAlarm&action=showMalFileAlarm"
        clientHeight={clientHeight}
        columnvalue="maliceColumnvalue"
        tableKey="maliceTable"
        rowkey='id'
        incID={incID}
