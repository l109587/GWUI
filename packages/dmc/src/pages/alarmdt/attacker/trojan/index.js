...
export default function Trojan(props) {
  ...
  const columnlist = [
    ...
    {
      title: language('alarmdt.attacker.trojanfamilyname'),
    ...
    {
      title: language('alarmdt.attacker.controlbehaviordesc'),
      dataIndex: 'behavior',
      key: 'behavior',
      width: '130px',
      ellipsis: true,
  ...
  return (
    <>
      <ProtableModule
        columns={columns}
        apishowurl="/cfg.php?controller=logAlarm&action=showTrojanAlarm"
