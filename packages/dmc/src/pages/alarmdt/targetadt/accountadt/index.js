...
export default function Trojan() {
  ...
  const columns = [
    ...
    {
      title: language('alarmdt.targetadt.sender'),
      dataIndex: 'sender',
      key: 'sender',
      width: '100px',
      ellipsis: true,
    ...
    {
      title:language('alarmdt.targetadt.receiver'),
      dataIndex: 'receiver',
      key: 'receiver',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.targetadt.cc'),
      dataIndex: 'cc',
      key: 'cc',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.targetadt.subject'),
      dataIndex: 'subject',
      key: 'subject',
      width: '100px',
      ellipsis: true,
    ...
    {
      title: language('alarmdt.targetadt.content'),
      dataIndex: 'content',
      key: 'content',
      width: '140px',
      ellipsis: true,
    ...
    {
      title:language('alarmdt.targetadt.attachs'),
      dataIndex: 'attachs',
      key: 'attachs',
      width: '140px',
      ellipsis: true,
  ...
  return (
    <>
      <ProtableModule
        columns={columns}
        apishowurl="/cfg.php?controller=logAlarm&action=showAccountAuditAlarm"
